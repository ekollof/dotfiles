...
local screenlockcmd = "xscreensaver-command -lock"
...
run_once.run("unclutter -root")
run_once.run("xrdb -I$HOME ~/.Xresources")
...
if widescreen then
    ...
    run_once.run(wallpapercmd)
end

run_once.run("xscreensaver -nosplash &")
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    --]]
    -- Change wallpaper/shell color scheme
    awful.key({"Control", altkey}, "w",
    function ()
	if widescreen then
	    awful.spawn.with_shell(wallpapercmdwide)
	else
	    awful.spawn.with_shell(wallpapercmd)
	end
    end,
